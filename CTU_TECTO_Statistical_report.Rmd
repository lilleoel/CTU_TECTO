...
\newpage
# Table 2 - Family Environment Scale (FES)

```{r}
tbl_func(df,strat_var="group",vars=c("Cohesion","Expressiveness","Conflict"), first.col.name = "Relationship Dimensions")
tbl_func(df,strat_var="group",vars=c("Achievement Orientation","Intellectual-Cultural Orientation","Active-Recreational Orientation","Moral-Religious Emphasis"), first.col.name = "Personal Growth Dimensions")
tbl_func(df,strat_var="group",vars=c("Oranization","Control"), first.col.name = "System Maintenance Dimensions")

```

\newpage
# Table 3 - Diagnostic status and comorbidities at baseline
...
\newpage
# Supplemental Table 1 - Psychopathological scores

**Refers to Figure 1**

# Supplemental Table 2 - Kidscreen-52
